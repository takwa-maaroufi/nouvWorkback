...
public interface AddToCartRepo extends JpaRepository<AddtoCart,Long> {
    ...
    List<AddtoCart> getCartByuserId(@Param("user_id")String user_id);
    ...
    Optional<AddtoCart> getCartByProductIdAnduserId(@Param("user_id")String user_id,@Param("product_id")Long product_id);
    @Modifying
    @Transactional
